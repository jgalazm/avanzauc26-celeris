...
fn sineWave(x: f32, y: f32, t: f32, d: f32, amplitude: f32, period: f32, theta: f32, phase: f32, current_boundary: i32) -> vec3<f32> {
    ...
    eta = rect_suave(y, 5.0, 3.0, 0.0) * eta_b;
    eta = eta + rect_suave(y, 10.0, 3.0, 0.0) * eta_b;
    eta = eta + rect_suave(y, 15.0, 3.0, 0.0) * eta_b;
    eta = eta + rect_suave(y, 20.0, 3.0, 0.0) * eta_b;
    eta = eta + rect_suave(y, 25.0, 3.0, 0.0) * eta_b;
